...
export default function FnFQ1_2026Dashboard() {
  ...
  const incomeStatementDataBase = normalizeYearDataset({
    ...
    '2025_4Q': {
      ...
      선물환손익: -4172,     // 파생상품 관련
      금융상품손익: 200,     // 금융상품평가손익
      이자손익: -1807,       // 이자수익 - 이자비용 (당분기 기준)
      배당수익: 100,         // 배당금수익
      기타손익: -1291,       // 영업외손익 - (1)~(6) 합계
      지분법손익: 79431,     // 지분법이익 - 지분법손실
      기부금: 19,            // 기부금 차이 (4Q 환입)
    ...
    '2025_Year': {
      ...
      이자손익: -7847,       // 이자수익 - 이자비용
      배당수익: 955,         // 배당금수익
      기타손익: -10635,      // 영업외손익 - (1)~(6) 합계
      지분법손익: 89825,     // 지분법이익 - 지분법손실
      기부금: -64,           // 기부금 (비용)
