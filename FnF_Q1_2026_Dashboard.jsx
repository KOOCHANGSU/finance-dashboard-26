...
export default function FnFQ1_2026Dashboard() {
  ...
  if (entityData['매출액']) {
    entityData['매출액']['2026_1Q']      = { 'OC(국내)': 223917, '중국': 303083, '홍콩': 25832, '엔터테인먼트': 597, 'ST미국': 7469 };
    entityData['매출액']['2026_1Q_Year'] = { 'OC(국내)': 223917, '중국': 303083, '홍콩': 25832, '엔터테인먼트': 597, 'ST미국': 7469 };
  }
  if (entityData['매출원가']) {
