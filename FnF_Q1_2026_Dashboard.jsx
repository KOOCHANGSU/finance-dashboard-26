...
export default function FnFQ1_2026Dashboard() {
  ...
  const entityData = normalizeYearDataset({
    '매출액': {
      ...
      '2025_1Q': { 'OC(국내)': 217147, '중국': 258540, '홍콩': 20663, 'ST미국': 8505, '엔터테인먼트': 761, '기타': 0 },
      '2025_1Q_Year': { 'OC(국내)': 217147, '중국': 258540, '홍콩': 20663, 'ST미국': 8505, '엔터테인먼트': 761, '기타': 0 },
    ...
    '매출원가': {
      ...
      '2025_1Q': { 'OC(국내)': 74119, '중국': 203778, '홍콩': 9671, 'ST미국': 1966, '엔터테인먼트': 1530, '기타': -115182 },
      '2025_1Q_Year': { 'OC(국내)': 74119, '중국': 203778, '홍콩': 9671, 'ST미국': 1966, '엔터테인먼트': 1530, '기타': -115182 },
    ...
    '매출총이익': {
      ...
      '2025_1Q': { 'OC(국내)': 143028, '중국': 54762, '홍콩': 10992, 'ST미국': 6539, '엔터테인먼트': -769, '기타': 115181 },
      '2025_1Q_Year': { 'OC(국내)': 143028, '중국': 54762, '홍콩': 10992, 'ST미국': 6539, '엔터테인먼트': -769, '기타': 115181 },
  ...
  if (entityData['매출원가']) {
    ...
    entityData['매출원가']['2026_1Q_Year'] = { 'OC(국내)': 77444, '중국': 239238, '홍콩': 10848, 'ST미국': 2261, '엔터테인먼트': 827, '기타': -137480 };
  }
  if (entityData['매출총이익']) {
    entityData['매출총이익']['2026_1Q']      = { 'OC(국내)': 146428, '중국': 63845, '홍콩': 14984, 'ST미국': 5252, '엔터테인먼트': -230, '기타': 137481 };
    entityData['매출총이익']['2026_1Q_Year'] = { 'OC(국내)': 146428, '중국': 63845, '홍콩': 14984, 'ST미국': 5252, '엔터테인먼트': -230, '기타': 137481 };
  }
  // ─────────────────────────────────────────────────────────────────────────
  ...
  const renderIncomeTab = () => {
    ...
    const getEntityDisplayName = (entity) => {
      ...
      if (selectedAccount === '매출액' && entity === 'OC(국내)') return 'OC(국내/제3자수출)';
      return entity;
    };
    ...
    const operatingItems = [
      ...
      { key: '판관비율', label: '판관비율', depth: 0, isRate: true, rateOf: ['판매비와관리비', '매출액'], highlight: 'blue' },
