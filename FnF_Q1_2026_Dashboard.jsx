              ...
              <div className="mt-5 space-y-4">
                ...
                <div className="bg-white rounded-lg border border-zinc-200 shadow-sm overflow-hidden">
                  <div className="bg-zinc-50 px-3 py-2 border-b border-zinc-200 flex justify-between items-center">
                    <div>
                      <span className="text-sm font-semibold text-zinc-800">[거래손익]</span>
                      <span className="text-xs text-zinc-500 ml-2">외화 채권/채무 결제 시 실현 손익</span>
                    </div>
                    <span className="text-xs text-zinc-500">외화: 천 단위 | 원화: 백만원</span>
                  </div>
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                      <thead>
                        ...
                        <tr className="bg-zinc-50 border-b border-zinc-100 text-xs">
                          ...
                          <th rowSpan={2} className="text-center px-2 py-1.5 font-medium text-zinc-600 w-[55px]">결제환율</th>
                          <th rowSpan={2} className="text-center px-2 py-1.5 font-medium text-zinc-600 w-[45px]">비율</th>
                          <th colSpan={2} className="text-center px-1 py-1 font-medium text-zinc-600 border-b border-zinc-200">거래금액</th>
                      ...
                      <tbody>
                        ...
                        <tr className="border-b border-zinc-100 hover:bg-zinc-50 transition-colors">
                          ...
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">190.4</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">196.7</td>
                          <td className="text-right px-2 py-2 text-blue-600 tabular-nums font-medium">+3.3%</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">606,101</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">115,427</td>
                          <td className="text-right px-2 py-2 text-zinc-700 tabular-nums font-medium border-r border-zinc-300">{formatNumber(3780)}</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">199.5</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">205.2</td>
                          <td className="text-right px-2 py-2 text-blue-600 tabular-nums font-medium">+2.9%</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">930,058</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">185,535</td>
                          <td className="text-right px-2 py-2 text-zinc-800 tabular-nums font-semibold">{formatNumber(5273)}</td>
                        </tr>
                        <tr className="border-b border-zinc-100 hover:bg-zinc-50 transition-colors">
                          <td className="text-center px-2 py-2 text-zinc-600 border-r border-zinc-100">USD</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">1,352.6</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">1,346.9</td>
                          <td className="text-right px-2 py-2 text-rose-600 tabular-nums font-medium">-0.4%</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">4,999</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">6,762</td>
                          <td className="text-right px-2 py-2 text-rose-600 tabular-nums font-medium border-r border-zinc-300">({formatNumber(28)})</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">1,455.7</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">1,482.0</td>
                          <td className="text-right px-2 py-2 text-blue-600 tabular-nums font-medium">+1.8%</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">3,002</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">4,370</td>
                          <td className="text-right px-2 py-2 text-zinc-800 tabular-nums font-semibold">{formatNumber(79)}</td>
                        </tr>
                        <tr className="border-b border-zinc-100 hover:bg-zinc-50 transition-colors">
                          ...
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">6,232</td>
                          <td className="text-right px-2 py-2 text-zinc-700 tabular-nums font-medium border-r border-zinc-300">{formatNumber(252)}</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">4,061</td>
                          <td className="text-right px-2 py-2 text-zinc-800 tabular-nums font-semibold">{formatNumber(194)}</td>
                        </tr>
                        {/* 채무 (2행 병합) */}
                        <tr className="border-b border-zinc-100 hover:bg-zinc-50 transition-colors">
                          <td rowSpan={2} className="text-center px-2 py-2 text-zinc-700 font-semibold border-r border-zinc-200 align-middle">채무</td>
                          <td className="text-center px-2 py-2 text-zinc-600 border-r border-zinc-100">USD</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">1,346.5</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">1,378.9</td>
                          <td className="text-right px-2 py-2 text-blue-600 tabular-nums font-medium">+2.4%</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">61,752</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">83,146</td>
                          <td className="text-right px-2 py-2 text-rose-600 tabular-nums font-medium border-r border-zinc-300">({formatNumber(2004)})</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">1,454.3</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">1,479.9</td>
                          <td className="text-right px-2 py-2 text-blue-600 tabular-nums font-medium">+1.8%</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">64,564</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">93,893</td>
                          <td className="text-right px-2 py-2 text-rose-600 tabular-nums font-semibold">({formatNumber(1658)})</td>
                        </tr>
                        <tr className="border-b border-zinc-100 hover:bg-zinc-50 transition-colors">
                          <td className="text-center px-2 py-2 text-zinc-600 border-r border-zinc-100">기타</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          ...
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">3,551</td>
                          <td className="text-right px-2 py-2 text-rose-600 tabular-nums font-medium border-r border-zinc-300">({formatNumber(2)})</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-600 tabular-nums">0</td>
                          <td className="text-right px-2 py-2 text-rose-600 tabular-nums font-semibold">({formatNumber(4)})</td>
                        </tr>
                        {/* 기타(연결) */}
                        <tr className="border-b border-zinc-200 hover:bg-zinc-50 transition-colors">
                          ...
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-700 tabular-nums font-medium border-r border-zinc-300">{formatNumber(95)}</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-400 tabular-nums">-</td>
                          <td className="text-right px-2 py-2 text-zinc-800 tabular-nums font-semibold">{formatNumber(307)}</td>
                        </tr>
                        {/* 합계 */}
                        <tr className="bg-zinc-100 font-semibold">
                          <td colSpan={7} className="px-3 py-2 text-zinc-800 border-r border-zinc-200">거래손익 계</td>
                          <td className="text-right px-2 py-2 text-zinc-700 tabular-nums border-r border-zinc-300">{formatNumber(2093)}</td>
                          <td colSpan={5} className=""></td>
                          <td className="text-right px-2 py-2 text-zinc-900 tabular-nums">{formatNumber(4191)}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                ...
                <div className="bg-white rounded-lg border border-zinc-200 shadow-sm overflow-hidden">
                  <div className="bg-zinc-50 px-3 py-2 border-b border-zinc-200 flex justify-between items-center">
                    <div>
                      <span className="text-sm font-semibold text-zinc-800">[평가손익]</span>
                      <span className="text-xs text-zinc-500 ml-2">기말 외화 자산/부채 환산 미실현 손익</span>
                    </div>
                    <span className="text-xs text-zinc-500">외화: 천 단위 | 원화: 백만원</span>
                  </div>
                  <div className="overflow-x-auto">
                ...
                <div className="bg-zinc-50 rounded-lg border border-zinc-200 p-3">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-semibold text-zinc-800">외환손익 합계 (거래 + 평가)</span>
                    <div className="flex gap-6 text-sm tabular-nums">
                      <div className="text-center">
                        <div className="text-xs text-zinc-500">24.4Q</div>
                        <div className="font-semibold text-zinc-700">{formatNumber(7220)}</div>
                      </div>
                      <div className="text-center">
                        <div className="text-xs text-zinc-500">25.4Q</div>
                        <div className="font-semibold text-zinc-900">{formatNumber(4666)}</div>
                      </div>
                      <div className="text-center">
                        <div className="text-xs text-zinc-500">YoY</div>
                        <div className="font-semibold text-rose-600">{formatNumber(-2554)}</div>
                      </div>
                    </div>
                  </div>
                </div>
                
                <p className="text-xs text-zinc-400">* 4Q 분기(3개월) 기준 | 환율: 원/외화</p>

                {/* ─────────── FY26 1Q FNF 외환손익 상세 보고 ─────────── */}
                <div className="mt-2 pt-5 border-t-2 border-blue-100 space-y-5">
                  {/* 섹션 헤더 */}
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-bold text-blue-800 bg-blue-50 border border-blue-200 px-2 py-0.5 rounded">FY26 1Q FNF 외환손익 상세</span>
                    <span className="text-xs text-zinc-400">기준일: 2026-03-31</span>
                  </div>

                  {/* KPI 4 cards */}
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                    {[
                      { label: '순외환손익 (26.1Q)', value: '+144.04', unit: '억원', sub: '평가 +86.5 + 거래 +57.6', footer: 'YoY(vs 25.1Q) +177.6억', color: 'text-blue-600' },
                      { label: '평가손익 (미실현)', value: '+86.47', unit: '억원', sub: '채권 +99.3 / 채무 -12.9', footer: '잔액 702억 × Δrate', color: 'text-blue-600' },
                      { label: '거래손익 (실현)', value: '+57.57', unit: '억원', sub: '채권 +56.2 / 채무 -5.1 / 기타 +6.4', footer: 'CNY 2,759억 수금 청산이익', color: 'text-blue-600' },
                      { label: '기말환율 QoQ', value: 'USD 1,513', unit: '', sub: 'QoQ +5.47% · CNY 218.70 (+6.81%)', footer: 'HKD 193.15 · EUR 1,733 · TWD 47.21', color: 'text-red-600' },
                    ].map((card, i) => (
                      <div key={i} className="bg-white rounded-lg shadow-sm border border-slate-200 p-4 flex flex-col gap-1">
                        ...
                        <div className="text-xs font-medium text-slate-400">{card.footer}</div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                    <div className="bg-slate-50 px-3 py-2 border-b border-slate-200">
                      <span className="text-sm font-semibold text-slate-800">① 거래손익 상세</span>
                      <span className="text-xs text-slate-500 ml-2">(억원 · 실현) — 통화×구분 · 청산금액 · 장부환율 vs 결제환율 · 25.1Q YoY</span>
                    </div>
                    <div className="overflow-x-auto">
                      <table className="w-full text-xs">
                        <thead>
                          <tr className="bg-slate-100 border-b border-slate-200 text-slate-700">
                            <th className="text-left px-2 py-1.5 font-semibold border-r border-slate-200 whitespace-nowrap">통화</th>
                            <th className="text-left px-2 py-1.5 font-semibold border-r border-slate-200 whitespace-nowrap">구분</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 whitespace-nowrap">청산금액<br/>(외화M)</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 whitespace-nowrap">청산금액<br/>(억KRW)</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 bg-sky-50 text-sky-700 whitespace-nowrap">장부환율<br/>(invoice)</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 bg-sky-50 text-sky-700 whitespace-nowrap">결제환율</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 whitespace-nowrap">Δ환율</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 bg-yellow-50 text-blue-700 whitespace-nowrap">26.1Q<br/>거래손익</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 whitespace-nowrap">25.1Q<br/>거래손익</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 bg-emerald-50 text-emerald-700 whitespace-nowrap">YoY<br/>차이</th>
                            <th className="text-left px-2 py-1.5 font-semibold whitespace-nowrap">비고</th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-100">
                          {[
                            { ccy:'USD', div:'채권 회수', fcyM:'6.79', krw:'98.4', book:'923.83', settle:'1,448.57', delta:'+56.80%', pl26:'+35.63', pl25:'+6.78', yoy:'+28.85', note:'매출 +35.59 / 미수 +0.04', plPos:true, yoyPos:true },
                            { ccy:'USD', div:'채무 지급', fcyM:'84.53', krw:'-1,234.9', book:'1,452.66', settle:'1,460.89', delta:'+0.57%', pl26:'-6.96', pl25:'-13.21', yoy:'+6.25', note:'매입 -0.74 / 미지급 -6.22', plPos:false, yoyPos:true },
                            { ccy:'USD', div:'대여금 회수', fcyM:'18.00', krw:'258.3', book:'1,434.90', settle:'1,513.40', delta:'+5.47%', pl26:'+2.84', pl25:'0.00', yoy:'+2.84', note:'STO대여금 회수', plPos:true, yoyPos:true },
                            { ccy:'CNY', div:'채권 회수', fcyM:'1,326.52', krw:'2,759.3', book:'206.07', settle:'208.01', delta:'+0.94%', pl26:'+25.75', pl25:'-37.76', yoy:'+63.51', note:'매출 +25.75 / 미수 0.00', plPos:true, yoyPos:true },
                            { ccy:'CNY', div:'채무 지급', fcyM:'—', krw:'—', book:'—', settle:'—', delta:'—', pl26:'-0.01', pl25:'0.00', yoy:'-0.01', note:'매입 0.00 / 미지급 -0.01', plPos:false, yoyPos:false },
                            { ccy:'HKD', div:'채권 회수', fcyM:'40.61', krw:'75.6', book:'187.55', settle:'186.24', delta:'-0.70%', pl26:'-0.53', pl25:'+2.43', yoy:'-2.96', note:'매출 -0.52 / 미수 -0.01', plPos:false, yoyPos:false },
                          ].map((r,i) => (
                            <tr key={i} className="hover:bg-slate-50">
                              <td className="px-2 py-1 font-medium text-slate-700 border-r border-slate-100">{r.ccy}</td>
                              <td className="px-2 py-1 text-slate-600 border-r border-slate-100 whitespace-nowrap">{r.div}</td>
                              <td className="px-2 py-1 text-right tabular-nums border-r border-slate-100">{r.fcyM}</td>
                              <td className="px-2 py-1 text-right tabular-nums border-r border-slate-100">{r.krw}</td>
                              <td className="px-2 py-1 text-right tabular-nums bg-sky-50 border-r border-slate-100">{r.book}</td>
                              <td className="px-2 py-1 text-right tabular-nums bg-sky-50 border-r border-slate-100">{r.settle}</td>
                              <td className={`px-2 py-1 text-right tabular-nums border-r border-slate-100 ${r.delta.startsWith('+') ? 'text-rose-600' : r.delta.startsWith('-') ? 'text-blue-600' : ''}`}>{r.delta}</td>
                              <td className={`px-2 py-1 text-right tabular-nums bg-yellow-50 font-semibold border-r border-slate-100 ${r.plPos ? 'text-blue-600' : 'text-red-600'}`}>{r.pl26}</td>
                              <td className="px-2 py-1 text-right tabular-nums border-r border-slate-100 text-slate-600">{r.pl25}</td>
                              <td className={`px-2 py-1 text-right tabular-nums bg-emerald-50 font-semibold border-r border-slate-100 ${r.yoyPos ? 'text-emerald-700' : 'text-red-600'}`}>{r.yoy}</td>
                              <td className="px-2 py-1 text-slate-500 whitespace-nowrap">{r.note}</td>
                            </tr>
                          ))}
                          <tr className="bg-slate-100 font-semibold border-t border-slate-300">
                            <td colSpan={7} className="px-2 py-1.5 text-slate-700 border-r border-slate-200">합계</td>
                            <td className="px-2 py-1.5 text-right tabular-nums bg-yellow-100 border-r border-slate-200 text-blue-700">+57.57</td>
                            <td className="px-2 py-1.5 text-right tabular-nums border-r border-slate-200 text-slate-600">-31.78</td>
                            <td className="px-2 py-1.5 text-right tabular-nums bg-emerald-100 border-r border-slate-200 text-emerald-700">+89.35</td>
                  ...
                  <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                    <div className="bg-slate-50 px-3 py-2 border-b border-slate-200">
                      <span className="text-sm font-semibold text-slate-800">② 평가손익 상세</span>
                      <span className="text-xs text-slate-500 ml-2">(억원 · 미실현) — 영업자산 · 금융자산 · 영업부채 · 25.1Q YoY</span>
                    </div>
                    <div className="overflow-x-auto">
                      <table className="w-full text-xs">
                        <thead>
                          <tr className="bg-slate-100 border-b border-slate-200 text-slate-700">
                            <th className="text-left px-2 py-1.5 font-semibold border-r border-slate-200 whitespace-nowrap">통화</th>
                            <th className="text-left px-2 py-1.5 font-semibold border-r border-slate-200 whitespace-nowrap">구분</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 whitespace-nowrap">잔액<br/>(외화M)</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 whitespace-nowrap">잔액<br/>(억KRW)</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 bg-sky-50 text-sky-700 whitespace-nowrap">장부환율<br/>(25.4Q)</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 bg-sky-50 text-sky-700 whitespace-nowrap">평가환율<br/>(26.1Q)</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 whitespace-nowrap">Δ환율</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 bg-yellow-50 text-blue-700 whitespace-nowrap">26.1Q<br/>평가손익</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 whitespace-nowrap">25.1Q<br/>평가손익</th>
                            <th className="text-right px-2 py-1.5 font-semibold border-r border-slate-200 bg-emerald-50 text-emerald-700 whitespace-nowrap">YoY<br/>차이</th>
                            <th className="text-left px-2 py-1.5 font-semibold whitespace-nowrap">비고</th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-100">
                          {[
                            { ccy:'USD', div:'영업자산', fcyM:'4.91', krw:'71.6', book:'1,434.90', eval:'1,513.40', delta:'+5.47%', pl26:'+2.98', pl25:'-1.41', yoy:'+4.39', note:'매출 +2.88 / 미수 +0.10', plPos:true, yoyPos:true },
                            { ccy:'USD', div:'금융자산', fcyM:'78.17', krw:'1,137.8', book:'예1,446/대1,482', eval:'1,513.40', delta:'+5.47%', pl26:'+54.70', pl25:'—', yoy:'+54.70', note:'예금 +39.00 / 대여 +15.70', plPos:true, yoyPos:true },
                            { ccy:'USD', div:'영업부채', fcyM:'26.57', krw:'-389.4', book:'1,434.90', eval:'1,513.40', delta:'+5.47%', pl26:'-12.85', pl25:'+13.82', yoy:'-26.67', note:'매입 -8.28 / 미지급 -4.57', plPos:false, yoyPos:false },
                            { ccy:'CNY', div:'영업자산', fcyM:'105.91', krw:'225.9', book:'204.76', eval:'218.70', delta:'+6.81%', pl26:'+5.41', pl25:'+1.22', yoy:'+4.19', note:'매출 +4.64 / 미수 +0.77', plPos:true, yoyPos:true },
                            { ccy:'CNY', div:'금융자산', fcyM:'524.22', krw:'1,128.2', book:'예215.23', eval:'218.70', delta:'+6.81%', pl26:'+18.21', pl25:'—', yoy:'+18.21', note:'예금 +18.21', plPos:true, yoyPos:true },
                            { ccy:'HKD', div:'영업자산', fcyM:'200.62', krw:'342.9', book:'184.41', eval:'193.15', delta:'+4.74%', pl26:'+16.57', pl25:'+2.43', yoy:'+14.14', note:'매출 +19.79 / 손실 -3.23', plPos:true, yoyPos:true },
                          ].map((r,i) => (
                            <tr key={i} className="hover:bg-slate-50">
                              <td className="px-2 py-1 font-medium text-slate-700 border-r border-slate-100">{r.ccy}</td>
                              <td className="px-2 py-1 text-slate-600 border-r border-slate-100 whitespace-nowrap">{r.div}</td>
                              ...
                              <td className="px-2 py-1 text-right tabular-nums border-r border-slate-100">{r.krw}</td>
                              <td className="px-2 py-1 text-right tabular-nums bg-sky-50 border-r border-slate-100">{r.book}</td>
                              <td className="px-2 py-1 text-right tabular-nums bg-sky-50 border-r border-slate-100">{r.eval}</td>
                              <td className="px-2 py-1 text-right tabular-nums border-r border-slate-100 text-rose-600">{r.delta}</td>
                              <td className={`px-2 py-1 text-right tabular-nums bg-yellow-50 font-semibold border-r border-slate-100 ${r.plPos ? 'text-blue-600' : 'text-red-600'}`}>{r.pl26}</td>
                              <td className="px-2 py-1 text-right tabular-nums border-r border-slate-100 text-slate-600">{r.pl25}</td>
                              <td className={`px-2 py-1 text-right tabular-nums bg-emerald-50 font-semibold border-r border-slate-100 ${r.yoyPos ? 'text-emerald-700' : 'text-red-600'}`}>{r.yoy}</td>
                              <td className="px-2 py-1 text-slate-500 whitespace-nowrap">{r.note}</td>
                          ...
                          <tr className="bg-slate-100 font-semibold border-t border-slate-300">
                            <td colSpan={7} className="px-2 py-1.5 text-slate-700 border-r border-slate-200">합계</td>
                            <td className="px-2 py-1.5 text-right tabular-nums bg-yellow-100 border-r border-slate-200 text-blue-700">+86.47</td>
                            <td className="px-2 py-1.5 text-right tabular-nums border-r border-slate-200 text-slate-600">-1.76</td>
                            <td className="px-2 py-1.5 text-right tabular-nums bg-emerald-100 border-r border-slate-200 text-emerald-700">+88.23</td>
                            <td className="px-2 py-1.5"></td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                    <div className="bg-slate-50 px-3 py-2 border-b border-slate-200">
                      <span className="text-sm font-semibold text-slate-800">③ 25.1Q vs 26.1Q 차이 분석</span>
                    </div>
                    <div className="overflow-x-auto">
                      <table className="w-full text-xs">
                        <thead>
                          <tr className="bg-slate-100 border-b border-slate-200 text-slate-700">
                            <th className="text-left px-3 py-1.5 font-semibold border-r border-slate-200">항목</th>
                            <th className="text-right px-3 py-1.5 font-semibold border-r border-slate-200">25.1Q</th>
                            <th className="text-right px-3 py-1.5 font-semibold border-r border-slate-200 bg-yellow-50 text-blue-700">26.1Q</th>
                            <th className="text-right px-3 py-1.5 font-semibold bg-emerald-50 text-emerald-700">증감</th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-100">
                          {[
                            { label:'채권 잔액 (기말)', v25:'0.0억', v26:'701.6억', diff:'+701.5억', pos:true },
                            { label:'채무 잔액 (기말)', v25:'-0.0억', v26:'-389.6억', diff:'-389.6억', pos:false },
                            { label:'USD 환율 QoQ', v25:'-0.24%', v26:'+5.47%', diff:'KRW 약세 전환', pos:true },
                            { label:'CNY 환율 QoQ', v25:'+0.20%', v26:'+6.81%', diff:'일제 약세', pos:true },
                            { label:'평가손익', v25:'-1.76억', v26:'+86.47억', diff:'+88.23억', pos:true },
                            { label:'거래손익', v25:'-31.78억', v26:'+57.57억', diff:'+89.35억', pos:true },
                            { label:'순외환손익', v25:'-33.54억', v26:'+144.04억', diff:'+177.58억', pos:true, bold:true },
                          ].map((r,i) => (
                            <tr key={i} className={`hover:bg-slate-50 ${r.bold ? 'font-semibold bg-blue-50' : ''}`}>
                              <td className="px-3 py-1.5 text-slate-700 border-r border-slate-100">{r.label}</td>
                              <td className="px-3 py-1.5 text-right tabular-nums text-slate-500 border-r border-slate-100">{r.v25}</td>
                              <td className={`px-3 py-1.5 text-right tabular-nums bg-yellow-50 border-r border-slate-100 ${r.pos ? 'text-blue-600' : 'text-red-600'}`}>{r.v26}</td>
                              <td className={`px-3 py-1.5 text-right tabular-nums bg-emerald-50 ${r.pos ? 'text-emerald-700' : 'text-red-600'}`}>{r.diff}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                  ...
                  <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                    <div className="bg-slate-50 px-3 py-2 border-b border-slate-200">
                      <span className="text-sm font-semibold text-slate-800">④ 환율 기말 · 평균 추이</span>
                      <span className="text-xs text-slate-500 ml-2">(원/외화, 9분기)</span>
                    </div>
                    <div className="overflow-x-auto">
                      <table className="w-full text-xs">
                        <thead>
                          <tr className="bg-slate-100 border-b border-slate-200 text-slate-700">
                            <th className="text-left px-2 py-1.5 font-semibold border-r border-slate-200 w-14">통화</th>
                            {['24.1Q','24.2Q','24.3Q','24.4Q','25.1Q','25.2Q','25.3Q','25.4Q','26.1Q'].map(q => (
                              <th key={q} className={`text-right px-2 py-1.5 font-semibold border-r border-slate-200 whitespace-nowrap ${q==='26.1Q' ? 'bg-yellow-50 text-blue-700' : ''}`}>{q}</th>
                            ))}
                          </tr>
                        </thead>
                        <tbody>
                          <tr className="bg-slate-50 border-b border-slate-200">
                            <td colSpan={10} className="px-2 py-1 text-xs font-semibold text-slate-500">기말환율</td>
                          </tr>
                          {[
                            { ccy:'USD', vals:[1346.8,1389.2,1319.6,1470.0,1466.5,1356.4,1402.2,1434.9,1513.4] },
                            { ccy:'CNY', vals:[185.75,190.43,188.74,201.27,201.68,189.16,196.82,204.76,218.7] },
                            { ccy:'HKD', vals:[172.1,177.9,169.76,189.3,188.53,172.8,180.15,184.41,193.15] },
                            { ccy:'EUR', vals:[1452.93,1487.07,1474.06,1528.73,1587.85,1591.8,1644.5,1685.72,1733.37] },
                            { ccy:'TWD', vals:[42.13,42.71,41.77,44.81,44.17,46.6,46.01,45.91,47.21] },
                            { ccy:'JPY', vals:[8.89,8.64,9.25,9.36,9.82,9.39,9.44,9.18,9.47] },
                          ].map((r,i) => (
                            <tr key={i} className="border-b border-slate-100 hover:bg-slate-50">
                              <td className="px-2 py-1 font-medium text-slate-700 border-r border-slate-100">{r.ccy}</td>
                              {r.vals.map((v,j) => (
                                <td key={j} className={`px-2 py-1 text-right tabular-nums border-r border-slate-100 ${j===8 ? 'bg-yellow-50 font-semibold text-blue-700' : 'text-slate-700'}`}>{v.toLocaleString('ko-KR')}</td>
                              ))}
                            </tr>
                          ))}
                          <tr className="bg-slate-50 border-b border-slate-200 border-t-2 border-t-slate-200">
                            <td colSpan={10} className="px-2 py-1 text-xs font-semibold text-slate-500">평균환율</td>
                          </tr>
                          {[
                            { ccy:'USD', vals:[1328.45,1370.91,1359.38,1396.84,1452.66,1404.04,1385.28,1450.98,1465.16] },
                            { ccy:'CNY', vals:[184.56,188.93,189.23,193.98,199.33,193.99,193.54,204.65,211.61] },
                            { ccy:'HKD', vals:[169.88,175.36,174.27,179.67,186.73,179.93,177.12,186.56,187.54] },
                            { ccy:'EUR', vals:[1443.1,1475.88,1491.65,1489.1,1529.33,1589.4,1619.25,1688.27,1713.75] },
                            { ccy:'TWD', vals:[42.27,42.4,42.05,43.19,44.18,45.4,46.29,46.7,46.31] },
                          ].map((r,i) => (
                            <tr key={i} className="border-b border-slate-100 hover:bg-slate-50">
                              <td className="px-2 py-1 font-medium text-slate-700 border-r border-slate-100">{r.ccy}</td>
                              {r.vals.map((v,j) => (
                                <td key={j} className={`px-2 py-1 text-right tabular-nums border-r border-slate-100 ${j===8 ? 'bg-yellow-50 font-semibold text-blue-700' : 'text-slate-600'}`}>{v.toLocaleString('ko-KR')}</td>
                              ))}
                            </tr>
                          ))}
                        </tbody>
                    ...
                    <div className="px-3 py-2 border-t border-slate-100 bg-slate-50 text-xs text-slate-400">
                      * 매매기준율 · 주요환율.xlsx 기준 | JPY 평균환율 미포함
                    </div>
                  </div>
                </div>
              </div>
