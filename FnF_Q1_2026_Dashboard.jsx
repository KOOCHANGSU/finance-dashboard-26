...
export default function FnFQ1_2026Dashboard() {
  ...
  const entityData = normalizeYearDataset({
    '매출액': {
      ...
      '2025_1Q': { 'OC(국내)': 396770, '중국': 258540, '홍콩': 20663, 'ST미국': 8505, '엔터테인먼트': 761, '베트남': 134, '기타': -179757 },
      '2025_1Q_Year': { 'OC(국내)': 396770, '중국': 258540, '홍콩': 20663, 'ST미국': 8505, '엔터테인먼트': 761, '베트남': 134, '기타': -179757 },
    ...
    '매출원가': {
      ...
      '2025_1Q': { 'OC(국내)': 145093, '중국': 203778, '홍콩': 9671, 'ST미국': 1966, '엔터테인먼트': 1530, '베트남': 115, '기타': -186271 },
      '2025_1Q_Year': { 'OC(국내)': 145093, '중국': 203778, '홍콩': 9671, 'ST미국': 1966, '엔터테인먼트': 1530, '베트남': 115, '기타': -186271 },
    ...
    '매출총이익': {
      ...
      '2025_1Q': { 'OC(국내)': 251677, '중국': 54762, '홍콩': 10992, 'ST미국': 6539, '엔터테인먼트': -769, '베트남': 19, '기타': 6514 },
      '2025_1Q_Year': { 'OC(국내)': 251677, '중국': 54762, '홍콩': 10992, 'ST미국': 6539, '엔터테인먼트': -769, '베트남': 19, '기타': 6514 },
  ...
  if (entityData['매출액']) {
    entityData['매출액']['2026_1Q']      = { 'OC(국내)': 379909, '중국': 303083, '홍콩': 25832, 'ST미국': 7513, '엔터테인먼트': 597, '베트남': 190, '기타': -156226 };
    entityData['매출액']['2026_1Q_Year'] = { 'OC(국내)': 379909, '중국': 303083, '홍콩': 25832, 'ST미국': 7513, '엔터테인먼트': 597, '베트남': 190, '기타': -156226 };
  }
  if (entityData['매출원가']) {
    entityData['매출원가']['2026_1Q']      = { 'OC(국내)': 138686, '중국': 239238, '홍콩': 10848, 'ST미국': 2261, '엔터테인먼트': 827, '베트남': 162, '기타': -198884 };
    entityData['매출원가']['2026_1Q_Year'] = { 'OC(국내)': 138686, '중국': 239238, '홍콩': 10848, 'ST미국': 2261, '엔터테인먼트': 827, '베트남': 162, '기타': -198884 };
  }
  if (entityData['매출총이익']) {
    entityData['매출총이익']['2026_1Q']      = { 'OC(국내)': 241223, '중국': 63845, '홍콩': 14984, 'ST미국': 5252, '엔터테인먼트': -230, '베트남': 28, '기타': 42658 };
    entityData['매출총이익']['2026_1Q_Year'] = { 'OC(국내)': 241223, '중국': 63845, '홍콩': 14984, 'ST미국': 5252, '엔터테인먼트': -230, '베트남': 28, '기타': 42658 };
  }
  // ─────────────────────────────────────────────────────────────────────────
